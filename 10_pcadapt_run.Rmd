...
# LD prune the merged dataset

plink --allow-extra-chr --double-id --bfile merged --indep-pairwise 50 10 0.2 --out merged_LD

# create the LD thinned dataset

plink --allow-extra-chr --double-id --bfile merged \
      --extract merged_LD.prune.in \
      --make-bed \
      --out merged_LD_thinned
      
# seperate groups

plink --allow-extra-chr --double-id --bfile merged_LD_thinned --keep deceased_samples.txt --make-bed --out deceased_LD
plink --allow-extra-chr --double-id --bfile merged_LD_thinned --keep survivors_samples.txt --make-bed --out survivors_LD
...
path_to_file <- "C:/Users/shayl/OneDrive - Queen's University/TLRPaper/bedfiles/deceased_LD.bed"
...
path_to_file <- "C:/Users/shayl/OneDrive - Queen's University/TLRPaper/bedfiles/survivors_LD.bed"
